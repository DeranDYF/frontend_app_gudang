            ...
            <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                    <div class="mb-3 mb-sm-0">
                        <h5 class="card-title fw-semibold">Data Form Keluar</h5>
                        <p class="card-subtitle mb-0">Data diambil menggunakan API dari Backend App Gudang</p>
                    </div>
                </div>
                <div class="table-responsive">
                    <table id="tb_form_keluar" class="table border table-bordered text-nowrap">
                        <thead>
                            <tr>
                                <th>Kode Form Keluar</th>
                                <th>Nama Barang</th>
                                <th>Jumlah</th>
                            </tr>
                        </thead>
...
$(document).ready(function() {
    moment.locale('id');
    var tb_form_keluar = $("#tb_form_keluar").DataTable({
        "language": {
            "lengthMenu": "Show _MENU_"
        },
        ajax: {
            url: "<?php echo base_url('getAllKeluar') ?>",
            type: "GET",
            dataSrc: "",
        },
        columns: [{
